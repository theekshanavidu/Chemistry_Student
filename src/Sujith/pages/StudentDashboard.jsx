...
export default function StudentDashboard({ onNavigate, initialStudentData, onLogout, theme, toggleTheme }) {
      ...
      <body>
        <div class="invoice-container">
          ...
          <div class="footer">
            ...
            <p class="footer-text">SKCHEM.COM · Sajith K Kumara</p>
            <p class="footer-text" style="font-size: 8px; margin-top: 5px;">Generated by SKCHEM Student Portal</p>
          </div>
        </div>
    ...
    <div className="min-h-screen flex bg-gray-50 text-gray-800 relative">
      ...
      >
        <div className="flex flex-col flex-1 min-h-0">
          ...
          <nav className="p-4 space-y-6 overflow-y-auto flex-1 select-none">
            {/* Student Section */}
            <div>
              <p className="px-3 text-[10px] font-extrabold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3">Student</p>
              <ul className="space-y-1.5">
                <li className="relative px-1">
                  {activeTab === "dashboard" && (
                    <span className="absolute left-0 top-1.5 bottom-1.5 w-1 bg-red-600 dark:bg-red-500 rounded-r-full shadow-sm shadow-red-500/50" />
                  )}
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 cursor-pointer ${
                      activeTab === "dashboard"
                        ? "bg-red-50/80 dark:bg-red-950/20 text-red-600 dark:text-red-400 shadow-sm border border-red-100/50 dark:border-red-950/30"
                ...
                <li className="relative px-1">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 cursor-pointer ${
                      activeTab === "profile"
                        ? "bg-red-50/80 dark:bg-red-950/20 text-red-600 dark:text-red-400 shadow-sm border border-red-100/50 dark:border-red-950/30"
                        : "text-gray-650 dark:text-gray-400 hover:bg-gray-55 dark:hover:bg-gray-800/40 hover:text-gray-900 dark:hover:text-white"
                    }`}
                  >
                    <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                    My Profile
                  </button>
                </li>
                <li className="relative px-1">
                  {activeTab === "studentId" && (
                    <span className="absolute left-0 top-1.5 bottom-1.5 w-1 bg-red-650 dark:bg-red-500 rounded-r-full shadow-sm shadow-red-500/50" />
                  )}
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 cursor-pointer ${
                      activeTab === "studentId"
                        ? "bg-red-50/80 dark:bg-red-950/20 text-red-600 dark:text-red-400 shadow-sm border border-red-100/50 dark:border-red-950/30"
                        : "text-gray-655 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/40 hover:text-gray-900 dark:hover:text-white"
                    }`}
                  >
                    <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a3 3 0 100-6 3 3 0 000 6zm5-3h3m-3 4h3" /></svg>
                    My Student ID
                  </button>
                </li>
              </ul>
            ...
            {/* Classes Section */}
            <div>
              <p className="px-3 text-[10px] font-extrabold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3">Classes</p>
              <ul className="space-y-1.5">
                <li className="relative px-1">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 cursor-pointer ${
                      activeTab === "liveClasses"
                        ? "bg-red-50/80 dark:bg-red-950/20 text-red-600 dark:text-red-400 shadow-sm border border-red-100/50 dark:border-red-950/30"
                        : "text-gray-655 dark:text-gray-400 hover:bg-gray-55 dark:hover:bg-gray-800/40 hover:text-gray-900 dark:hover:text-white"
                    }`}
                  >
                    <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
                    Live Classes
                  </button>
                </li>
                <li className="relative px-1">
            ...
            {/* Purchase Section */}
            <div>
              <p className="px-3 text-[10px] font-extrabold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3">Purchase</p>
              <ul className="space-y-1.5">
                <li className="relative px-1">
                  ...
                  >
                    <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>
                    Bank Details
                  </button>
                </li>
                <li className="relative px-1">
                  ...
                  >
                    <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" /></svg>
                    Purchase Class
                  </button>
                </li>
              </ul>
            ...
            {/* Payments Section */}
            <div>
              <p className="px-3 text-[10px] font-extrabold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3">Payments</p>
              <ul className="space-y-1.5">
                <li className="relative px-1">
                  {activeTab === "payments" && (
                    <span className="absolute left-0 top-1.5 bottom-1.5 w-1 bg-red-600 dark:bg-red-500 rounded-r-full shadow-sm shadow-red-500/50" />
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto lg:overflow-y-auto">
        ...
        <header className="h-16 bg-white border-b border-gray-200 px-4 md:px-8 flex items-center justify-between sticky top-0 z-30">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="group px-3.5 py-2 text-xs font-bold text-red-700 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 bg-red-50 dark:bg-red-950/20 hover:bg-red-100 dark:hover:bg-red-900/30 transition-all rounded-xl border border-red-200 dark:border-red-900/40 shadow-sm flex items-center gap-1.5 cursor-pointer"
            ...
            >
              <svg
                ...
                viewBox="0 0 16 16"
                fill="currentColor"
                className="w-4 h-4 text-red-600 dark:text-red-400 transition-transform duration-700 ease-out group-hover:rotate-[360deg]"
              >
                <path d="M9.302 1.256a1.5 1.5 0 0 0-2.604 0l-1.704 2.98a.5.5 0 0 0 .869.497l1.703-2.981a.5.5 0 0 1 .868 0l2.54 4.444-1.256-.337a.5.5 0 1 0-.26.966l2.415.648a.5.5 0 0 0 .613-.354l.647-2.415a.5.5 0 0 0-.966-.259l-.333 1.242zM2.973 7.773l-1.255.337a.5.5 0 1 1-.26-.966l2.416-.648a.5.5 0 0 1 .613.354l.647 2.415a.5.5 0 0 1-.966.259l-.333-1.242-2.545 4.454a.5.5 0 0 0 .434.748H5a.5.5 0 0 1 0 1H1.735a1.5 1.5 0 0 1-1.302-2.246zm10.899.789a.5.5 0 0 1 .259.966l-2.416.648a.5.5 0 0 1-.613-.354l-.647-2.415a.5.5 0 1 1 .966-.259l.333 1.242 2.545-4.454a.5.5 0 0 1 .866 0z" />
              </svg>
              Refresh
            </button>
            ...
            <button
              onClick={toggleTheme}
              type="button"
              className="p-2 text-gray-500 hover:text-gray-850 dark:text-gray-400 dark:hover:text-white bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-xl transition-colors border border-gray-200 dark:border-gray-700 shadow-sm cursor-pointer flex items-center justify-center"
            ...
            {/* Notification Icon */}
            <div className="relative cursor-pointer text-gray-500 hover:text-gray-800 dark:hover:text-white">
          ...
          {activeTab === "studentId" && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              <div className="bg-white border border-gray-200 p-8 rounded-2xl shadow-md flex items-center justify-center">
                <div className="w-80 id-card-body bg-gradient-to-b from-gray-50 to-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden text-center flex flex-col items-center p-6 relative">
                  {/* Top color accent */}
        ...
        {/* ── Site Footer ── */}
        <footer className="border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-[#0f172a] px-6 md:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 flex-shrink-0 transition-colors duration-200">
          <p className="text-xs font-bold text-gray-700 dark:text-gray-300 tracking-wide">
            SKCHEM.COM <span className="text-red-500">·</span> Sajith K Kumara
          </p>
          <p className="text-[10px] text-gray-400 dark:text-gray-500 font-medium">
            Copyright &copy; {new Date().getFullYear()} Theekshana Viduranga <span className="font-mono text-red-500/80">&lt;/&gt;</span>
          </p>
        </footer>
      </div>
